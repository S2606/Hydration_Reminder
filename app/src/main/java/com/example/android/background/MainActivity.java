...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        receiver=new chargingbroadcast();
    ...
    public void incrementWater(View view) {
        ...
        mToast.show();
        Intent waterreminder=new Intent(this, WaterReminderIntentService.class);
        waterreminder.setAction(ReminderTasks.ACTION_INCREMENT_WATER_COUNT);
        startService(waterreminder);
    }
